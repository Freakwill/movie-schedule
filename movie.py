...
The number of full-screen movie halls'''%(d1, d2, self.check_rate(), self.total_hot(), self.ghot(), self.check_time()))
...
pop = Population([manager.initSchedule() for _ in range(10)])
pop.evolve()
